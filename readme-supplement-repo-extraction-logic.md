## Repo truncation business logic
  ...
  - Base fields: repository_metadata, language_stats, directory_tree, readme. These are truncated only as a last resort.
  ...
  Number of tokens is estimated as: bytes / bytes_per_token.
